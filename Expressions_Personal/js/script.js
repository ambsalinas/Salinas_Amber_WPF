...
var length1 = prompt("What is the length of the first rectangle?"); 

console.log("The length of the first rectangle is " + length1 + " feet."); 

var height1 = prompt("What is the height of the first rectangle?"); 